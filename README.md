...
| [`skills/3d-explainer-ad/`](skills/3d-explainer-ad/) | A Zack-D-style animated science-explainer ad: script first (eight blocks, approved on its own), one still per spoken line with the character anchor and product pinned as references, each still animated as its own start-image clip, one voiceover take timed by Whisper into the cut map, music ducked under. [`references/formulas.md`](skills/3d-explainer-ad/references/formulas.md) holds the genre rules — the sandwich, accent discipline, scene-brief patterns, the assembly recipe; [`evals.md`](skills/3d-explainer-ad/evals.md) records five cases, each from a measured failure in the build that produced the skill. |
